...
// calculateDownloadTime adds 2.5 hours to the broadcast start time and returns
// a cron expression in local time (America/New_York). The container's TZ env var
// ensures the scheduler evaluates cron in the correct timezone.
